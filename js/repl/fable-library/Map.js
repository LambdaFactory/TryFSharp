...
FSharpMap.prototype.GetHashCode = function () {
  ...
  while (e$$1.MoveNext()) {
    const activePatternResult3046 = e$$1.Current;
    res$$3 = combineHash(res$$3, structuralHash(activePatternResult3046[0]));
    res$$3 = combineHash(res$$3, structuralHash(activePatternResult3046[1]));
  }
